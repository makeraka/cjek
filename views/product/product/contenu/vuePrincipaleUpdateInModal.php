<div id="kt_app_content" class="app-content flex-column-fluid" data-select2-id="select2-data-kt_app_content">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl"
        ...
        <!--begin::Form-->
        <form action="<?= Yii::$app->request->baseUrl . '/' . md5("produit_productupdate") ?>" id="updateproduct"
            name="updateproduct" enctype="multipart/form-data" method="post"
            class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework"
            data-kt-redirect=""
            data-select2-id="select2-data-kt_ecommerce_add_product_form">
            <input type="hidden" name="_csrf" value="<?= Yii::$app->request->getCsrfToken() ?>" />
            <input type="hidden" name="action_key" id="action_key" value="<?= md5('updateproduit') ?>" />
            <input type="hidden" name="action_on_this" id="action_on_this" value="<?=$produitDtls['code']?>" />
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                ...
                <div class="card card-flush py-4 shadow-lg">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                            ...
                            <!--begin::Preview existing avatar-->
                                  ...
                                  <div id="image-cropper-result" class="image-input-wrapper w-150px  h-150px">
                                                <img style="width:150px; height:150px;" src="<?= yii::$app->request->baseUrl.''.yii::$app->params['linkToUploadIndividusProfil'].''.$produitDtls['photo']?>">
                                            </div>
                            ...
                            <!--end::Preview existing avatar-->
                                       ...
                                       <label
                                                ...
                                                <!--begin::Inputs-->
                                                <input type="hidden" name="avatar_remove" value="<?=$produitDtls['photo']?>" />
                        ...
                        <!--end::Image input-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7"><?= yii::t("app",'critère image')?></div>
                        <!--end::Description-->
                    </div>
                    <!--end::Card body-->
                </div>
                 ...
                 <div class="card card-flush py-4 shadow-lg">
                    ...
                    <div class="card-body pt-0">
                       ...
                       <input class="form-control" value="<?=$produitDtls['motcle']?>" name="motscles" id="kt_tagify_1"/>
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10 shadow-lg ">
                ...
                <ul class="nav mx-5 pt-5 nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2 "
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
                            href="#kt_ecommerce_add_product_general" aria-selected="true" role="tab"><?= yii::t("app",'généralité')?></a>
                    </li>
                    <!--end:::Tab item-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        <!--begin::Label-->
                                        <label class="col-sm-4 form-label required"><?= yii::t("app",'designation')?>:</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text"
                                      
                                            value="<?= (isset($produitDtls['libelle'])) ? $produitDtls['libelle']: Null ?>"
                                    ...
                                    <div class=" row fv-plugins-icon-container">
                                        ...
                                        <?php
                                                        if (isset($productCategories) && is_array($productCategories) && sizeof($productCategories) > 0) {
                                                        foreach ($productCategories as $data) : ?>
                                                                        <option value="<?= $data['code'] ?>"
                                                                            <?= ( $produitDtls['category']== $data['code']) ? 'selected' : '' ?>>
                                                                            <?= $data['libelle'] ?></option>;
                                                                        <?php endforeach;
                                                        }
                                                    ?>
                                  ...
                                  <div class="mb-10 row fv-plugins-icon-container">
                                        ...
                                        <div class="col-sm-11">
                                            <select name="productGroup" id="productGroup"  class="form-control form-select"  data-control="select2">
                                                ...
                                                <?php
                                                    ...
                                                    if (isset($listeGroupe) && is_array($listeGroupe) && sizeof($listeGroupe) > 0) {
                                                    foreach ($listeGroupe as $data) : ?>
                                                                    <option value="<?= $data['code'] ?>"
                                                                        <?= ( $produitDtls['codegroupe']== $data['code']) ? 'selected' : '' ?>>
                                                                        <?= $data['libelle'] ?></option>;
                                                                    <?php endforeach;
                                                    }?>
                                            </select>
                                    ...
                                    <!--end::Input group-->
                                     <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <!--begin::Input-->
                                         <input type="numeric"
                                            value="<?= (isset($produitDtls['prixunitairevente'])) ? $produitDtls['prixunitairevente']: Null ?>"
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <!--begin::Input-->
                                       <input type="dat"
                                            value="<?= (isset($produitDtls['dateajout'])) ? $produitDtls['dateajout']: Null ?>"
                                            class="form-control " name="dateajout" id="dateajout"
                                            autocomplete="off" />
                                        <span class="input-group-addon hidden-md hidden-lg"></span>
                                        <!--end::Input-->
                                        <!--begin::Description-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div>
                                        ...
                                        <textarea class="form-control" name="description" id="description" value="<?= (isset($produitDtls['description'])) ? $produitDtls['description']: Null ?>">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div id="kt_docs_repeater_basic">
                                                            ...
                                                            <div class="form-group">
                                                                <div data-repeater-list="kt_docs_rep?eater_basic">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <div class="col-md-5 ">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <?php
                                                                                    if (isset($listeRef) &&  is_array($listeRef) && sizeof($listeRef) > 0) {
                                                                                        foreach ($listeRef as $each_liste) : ?>
                                                                                    <option value="<?= $each_liste['code'] ?>"
                                                                                        >
                                                                                        <?= $each_liste['libelle'] ?></option>;
                                                                                    <?php
                                                                                        endforeach;
                                                                                    }
                                                                                    ?>
                                                                            ...
                                                                            <div class="col-md-5">
                                                                                ...
                                                                                <input type="text" name="contenue"value="<?= (isset($each_liste['contenu'])) ? $each_liste['contenu']: Null ?>"
                ...
                <div class="d-flex justify-content-end mx-5 mb-10">
                    <!--begin::Button-->
                    <a href="#" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Retour à l'accueil</a>
                    <!--end::Button-->
                    <!--begin::Button-->
                    <a href="javascript:;" id="updateproduct" onclick="update()"
                        class="btn btn-primary">
                        <span class="indicator-label"><?= Yii::t('app', 'edit') ?></span>
...
<?php
require('script/script_update.php');
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y ">
                ...
                <div class="modal-footer">
                    <button id="addcategorie" type="button" onClick="productCategorie_np()"
                        ...
                        <?= yii::t("app", 'veillez')?> <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                        </span></button>
...
<!--pour l'unité de vente -->


<!--begin::Modal - Add task-->
<div class="modal fade" id="newProductUdm" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered ">
        <!--begin::Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary" id="kt_modal_add_user_header">
                ...
                <!--begin::Modal title-->
                <h4 class="modal-title text-white" id="newProdCat"> <?= yii::t("app", 'nouveau uva')?></h4>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal"
                    data-kt-users-modal-action="close">
            ...
            <div class="modal-body scroll-y ">
                <!--begin::Form-->
                <form id="formaddudm" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    <?= Yii::$app->request->baseUrl."/".md5("catalog_udms") ?> method="post">
                    <input type="hidden" name="_csrf" value="<?= Yii::$app->request->getCsrfToken() ?>" />
                    <input type="hidden" name="action_key" id="action_key" value="<?= md5('addudns')?>" />
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2"><?= yii::t("app", 'nom uva')?></label>
                            <!--end::Label-->

                            <!--begin::Input-->
                            <input type="text" value="" class="form-control" name="productUdmNames" id="productUdmNa"  autocomplete="off"/>
                        ...
                        <!--end::Input group-->
                        <div class="fv-row mb-10">
                            <label class=" fw-semibold fs-6 mb-2"><?= yii::t("app",'desc')?></label>

                            <textarea rows="3" type="text" class="form-control" name="productUdmDescs" id="productUdmDe"  autocomplete="off"></textarea>
                    ...
                    <div class="text-center pt-15">
                        <button type="button" onClick="productUdm_np()"
                            class="btn btn-circle btn-primary" id="addproduitudm"><i class="glyphicon glyphicon-saved"></i>
                            <span class="indicator-label">
                                &nbsp;
                                <?= Yii::t('app','ajouter');?>
                            </span>
                        ...
                        <button type="button" onClick="cancel()" class="btn btn-circle btn-primary"
                            data-dismiss="modal"><i class="glyphicon glyphicon-remove-circle"></i>&nbsp;
                            <?= Yii::t('app','fermer');?></button>
    ...
    <div class="modal-dialog modal-dialog-centered ">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary" id="kt_modal_add_user_header">
                ...
                <!--begin::Modal title-->
                <h2 class="fw-bold text-white"><?= yii::t("app",'Ajouter Un Groupe')?></h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal"
                    data-kt-users-modal-action="close">
            ...
            <div class="modal-body">
                <form id="catgorieadd" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    ...
                    <!--begin::Input group-->
                    <div class="fv-row mb-10">
                        <label class="col-sm-4 form-label required"> <?= yii::t("app", 'ngrp')?>
                        </label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 form-label"> <?= yii::t("app", 'desc')?>
                        </label>
                        <div class="col-sm-12">
            ...
            <div class="modal-footer">
                <button id="bnaddGroup" type="button" onClick="productGroup_np()" class="btn btn-circle btn-primary"> <i
