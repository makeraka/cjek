        ...
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel">
                    <?= Yii::t('app', 'modifiebaner') ?>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form id="BanUpdate" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                action="<?= Yii::$app->request->baseUrl . "/" . md5("produit_banner") ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="fv-row mb-12">
                        ...
                        <div class="col-sm-12">
                            <select class="form-select" name="statutBanUpdate" id="statutBanUpdate">
                                <option value="1">
                                    <?= Yii::t('app', 'active') ?>
                                </option>
                                <option value="2">
                    ...
                    <div class="fv-row mb-12">
                        <label class="col-sm-4 form-label">
                            <?= Yii::t('app', 'Libelle') ?> <span class="asterisk">*</span>
                        </label>
                        <div class="fv-row mb-12">
                            <input type="text" value="" class="form-control" name="productBanNameUpdate"
                                id="productBanNameUpdate" autocomplete="off" />
                        </div>
                    </div>
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="productBanTitreUpdate" id="productBanTitreUpdate"
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="productBanStitreUpdate" id="productBanStitreUpdate"
                            class="form-control border-dark form-control-solid mb-3 mb-lg-0 " />
                        <!--end::Input-->
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15 mt-15">
				...
				<p>
					<input type="button" value="<?= yii::t("app", "validecrop") ?>" id="image-getterupdate"
						data-bs-target="#updateProductBan" data-bs-toggle="modal"
